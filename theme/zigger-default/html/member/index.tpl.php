...
<ul class="mypagebox">
    ...
    <li>
        ...
        <a href="<?php echo PH_DIR; ?>/member/point" class="btn2">포인트 내역 확인 <i class="fas fa-chevron-right"></i></a>
    </li>
    <li>
        <h5>받은 Message</h5>
        <span class="txt">
        ...
        <a href="<?php echo PH_DIR; ?>/message" class="btn2">모든 메시지 확인<i class="fas fa-chevron-right"></i></a>
    </li>
    <li>
        <h5>받은 Alarm</h5>
        <span class="txt">
        ...
        <a href="<?php echo PH_DIR; ?>/alarm" class="btn2">모든 알림 확인<i class="fas fa-chevron-right"></i></a>
    </li>
</ul>
