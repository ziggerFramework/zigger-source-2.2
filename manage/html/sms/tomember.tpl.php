<div id="sub-tit">
    <h2>회원 SMS 발송</h2>
    <em><i class="fa fa-exclamation-circle"></i>특정 혹은 레벨별 회원 SMS 발송</em>
</div>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <span class="tbl_sment">휴대전화 번호가 등록되어 있는 회원에게만 발송됩니다.</span>
                    </td>
                </tr>
                <tr data-type="1" class="hd-tr">
                    <th>수신 회원</th>
                    <td>
                        <input type="text" name="to_mb" class="inp" title="수신 회원" value="<?php echo $smsto; ?>" />
