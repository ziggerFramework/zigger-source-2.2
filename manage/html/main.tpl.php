        ...
        <div class="inner">
            <div class="wrap">
                ...
                <div class="box">
                    <div class="tit">
                        <h4>최근 가입 회원</h4>
                        <a href="<?php echo PH_MANAGE_DIR; ?>/member/result" class="more"><i class="fa fa-plus"></i><p>더 보기</p></a>
                    </div>
                    <div class="cont">
                        <table>
                            <colgroup>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="tac"><a href="<?php echo PH_MANAGE_DIR; ?>/member/modify?idx=<?php echo $list['mb_idx']; ?>" class="btn2 small">조회</a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                ...
                <div class="box">
                    <div class="tit">
                        <h4>최근 접속 회원</h4>
                        <a href="<?php echo PH_MANAGE_DIR; ?>/member/record" class="more"><i class="fa fa-plus"></i><p>더 보기</p></a>
                    </div>
                    <div class="cont">
                        <table>
                            <colgroup>
                ...
                <div class="box">
                    <div class="tit">
                        <h4>현재 접속 세션</h4>
                        <a href="<?php echo PH_MANAGE_DIR; ?>/member/session" class="more"><i class="fa fa-plus"></i><p>더 보기</p></a>
                    </div>
                    <div class="cont">
                        <table>
                            <colgroup>
