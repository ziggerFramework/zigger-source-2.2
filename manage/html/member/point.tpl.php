...
<div id="list-sort">
    <ul>
        <li><a href="point"><em>전체 변동 수</em><p><?php echo $act_total; ?></p></a></li>
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="modify?idx=<?php echo $list['mb_idx']; ?>" target="_blank"><strong><?php echo $list['mb_id']; ?></strong></a></td>
