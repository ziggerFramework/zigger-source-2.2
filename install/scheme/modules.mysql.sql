...
('mod:board:config:freeboard', 'secret_level', '10', now()),
...
('mod:board:config:freeboard', 'ico_new_case', '60', now()),
('mod:board:config:freeboard', 'ico_hot', 'Y', now()),
('mod:board:config:freeboard', 'ico_hot_case', '2|AND|1', now()),
...
('mod:board:config:news', 'secret_level', '10', now()),
...
('mod:board:config:news', 'ico_new_case', '60', now()),
('mod:board:config:news', 'ico_hot', 'Y', now()),
('mod:board:config:news', 'ico_hot_case', '2|AND|1', now()),
